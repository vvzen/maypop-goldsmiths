...
// this method extrudes in 3D the given string and returns a vector of ofMesh-es.
...
vector<ofMesh> extrude_mesh_from_text(string word, ofTrueTypeFont & font, float extrusion_depth, float scale, bool get_front_only);
